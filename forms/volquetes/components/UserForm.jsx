...
import AdminInputsResponsive from "../../../admin/zoonosis/features/AdminInputsResponsive";
    ...
    <div className="container">
      ...
      >
        ...
        <div className={matches ? "text-container" : "text-container-mobile"}>
          <p className="text">
          <span className="span-text">Ingrese usuario y contraseña para acceder al portal de volqueteras</span>
          </p>
        </div>
